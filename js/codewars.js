...
squareOrSquareRoot([4, 3, 9, 7, 2, 1]); //should get back [ 2, 9, 3, 49, 4, 1 ];
squareOrSquareRoot([100, 101, 5, 5, 1, 1]); //should get back [ 10, 10201, 25, 25, 1, 1 ];
squareOrSquareRoot([ 1, 2, 3, 4, 5, 6 ]); //should get back [ 1, 4, 9, 2, 25, 36 ];
...
order("is2 Thi1s T4est 3a"); //result should be "Thi1s is2 3a T4est")
order("4of Fo1r pe6ople g3ood th5e the2"); //result should be "Fo1r the2 g3ood 4of th5e pe6ople")
order(""); //result should be ""
...
function reverseLetter(str) {
	var reversedString = (str.split("").reverse().join(""));
  	...
  	var replacedNonInteger = reversedString.replace(/\s+/g, '-').replace(/[^a-zA-Z-]/g, '');
  	console.log(replacedNonInteger);
  
}



reverseLetter("krishan"); //should return "nahsirk"

reverseLetter("ultr53o?n"); //should return "nortlu"

reverseLetter("ab23c"); //should return "cba"

reverseLetter("krish21an"); //should return "nahsirk"
...
function getMiddle(s) {
	if (s.length % 2 === 0) {
		var halfString = s.length / 2;
		console.log(s[halfString - 1] + s[halfString]);
	} else {
		var halfString = (s.length / 2) - 0.5;
		console.log(s[halfString]);
	}
}
